...
inputs = {
  ...
  description  = "A Cloud9 environment for user  c9_amurill4 working on Latam PoC Rackspace team"
  profile_name = "io-la-prd-cloud9-iascode"
  subnet_id    = "subnet-0071b43fae302e86d"
  aws_username = "AWSReservedSSO_ADC-ABS-C9_e6abe037073c018e/arturo.murillo.ext@holcim.com"
}